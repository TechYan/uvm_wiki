...
class WebTests(unittest.TestCase):
    ...
    def test_rendered_html_contains_unified_views(self) -> None:
        ...
        self.assertIn('id="topologySearch"', html)
        self.assertIn('id="topologyRoot"', html)
        self.assertIn('id="topologyFocus"', html)
        self.assertIn("TOPOLOGY_MAX_SCENE_NODES=320", html)
        self.assertIn("function toggleTopologyNode", html)
        self.assertIn('class","topology-toggle"', html)
        self.assertNotIn("focusName", html)
